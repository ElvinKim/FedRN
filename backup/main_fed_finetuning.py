...
from models.Update import LocalUpdate, LocalUpdateFinetuning
...
if __name__ == '__main__':
    ...
    result_f = 'fed_finetuning_{}_{}_{}_BS[{}]_C[{}]_IID[{}]_LR[{}]_MMT[{}]_NT[{}]_NR[{}]_Tk[{}]_FTLE[{}].csv'.format(args.dataset, 
                                                                                       args.model, 
                                                                                       args.epochs, 
                                                                                       args.local_bs,
                                                                                       args.frac, 
    ...
    for iter in range(args.epochs):
        ...
        for idx in idxs_users:
            local = LocalUpdateFinetuning(args=args, dataset=dataset_train, idxs=dict_users[idx])
            w, loss = local.train(net=copy.deepcopy(net_glob).to(args.device), forget_rate=rate_schedule[iter])
            if args.all_clients:
