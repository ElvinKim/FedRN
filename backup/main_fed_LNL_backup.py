...
from models.Nets import MLP, CNNMnist, CNNCifar, MobileNetCifar, CNN4Conv
...
if __name__ == '__main__':
    ...
    elif args.model == 'cnn4conv' and args.dataset == 'cifar':
        net_glob = CNN4Conv(args=args).to(args.device)
