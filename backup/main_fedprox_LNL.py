...
if __name__ == '__main__':
    ...
    if args.iid:
        result_f = 'fedprox_{}_{}_{}_C[{}]_BS[{}]_LE[{}]_IID[{}]_LR[{}]_MMT[{}]_NT[{}]_NGN[{}]_GNR[{}]'.format(args.dataset, 
                                                                                                     args.model, 
                                                                                                     args.epochs, 
                                                                                                     args.frac, 
                                                                                                     args.local_bs, 
        ...
        result_f = 'fedprox_{}_{}_{}_C[{}]_BS[{}]_LE[{}]_IID[{}]_LR[{}]_MMT[{}]_NT[{}]_NGN[{}]_GNR[{}]_PT[{}]'.format(args.dataset, 
                                                                                                     args.model, 
                                                                                                     args.epochs, 
                                                                                                     args.frac, 
                                                                                                     args.local_bs, 
    ...
    for iter in range(args.epochs):
        ...
        if iter == int(args.epochs * 0.7):
            args.fedprox_mu *= 10

        for idx in idxs_users:
            local = LocalUpdateFedProx(args=args, dataset=dataset_train, idxs=dict_users[idx])
            w, loss = local.train(net=copy.deepcopy(net_glob).to(args.device), mu=args.fedprox_mu)
            if args.all_clients:
