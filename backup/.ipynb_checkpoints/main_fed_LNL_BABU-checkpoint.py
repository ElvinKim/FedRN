...
from models.Update import LocalUpdateBABU
...
if __name__ == '__main__':
    ...
    result_f = 'fedLNL_BABU_{}_{}_{}_C[{}]_IID[{}]_LR[{}]_MMT[{}]_NT[{}]_NR[{}].csv'.format(args.dataset, 
                                                                                       args.model, 
                                                                                       args.epochs, 
                                                                                       args.frac, 
                                                                                       args.iid,
    ...
    for iter in range(args.epochs):
        ...
        for idx in idxs_users:
            local = LocalUpdateBABU(args=args, dataset=dataset_train, idxs=dict_users[idx])
