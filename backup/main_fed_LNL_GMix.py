...
from models.Update import LocalUpdateGMix
...
if __name__ == '__main__':
    ...
    # Set Hyper-Parameters for MixMatch
    ...
    if args.iid:
        result_f = 'fedGMix{}_{}_{}_C[{}]_BS[{}]_LE[{}]_IID[{}]_LR[{}]_MMT[{}]_NT[{}]_NGN[{}]_GNR[{}]_PT[{}]'.format(args.dataset, 
                                                                                                     args.model, 
                                                                                                     args.epochs, 
                                                                                                     args.frac, 
                                                                                                     args.local_bs, 
        ...
        result_f = 'fedGMix_{}_{}_{}_C[{}]_BS[{}]_LE[{}]_IID[{}]_LR[{}]_MMT[{}]_NT[{}]_NGN[{}]_GNR[{}]'.format(args.dataset, 
                                                                                                     args.model, 
                                                                                                     args.epochs, 
                                                                                                     args.frac, 
                                                                                                     args.local_bs, 
    ...
    for epoch in range(args.epochs):
        ...
        for idx in idxs_users:
            local = LocalUpdateGMix(args=args, dataset=dataset_train, idxs=dict_users[idx])
            
            if epoch <= args.warm_up:
                w, loss = local.warmup(net=copy.deepcopy(net_glob).to(args.device))
            else:
                w, loss = local.train(net=copy.deepcopy(net_glob).to(args.device), g_epoch=epoch)
            if args.all_clients:
