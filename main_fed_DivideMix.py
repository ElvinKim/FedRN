...
from models.Update import LocalUpdate, LocalUpdateDivideMix 
...
if __name__ == '__main__':
    ...
    if args.iid:
        result_f = 'dividemix_{}_{}_{}_C[{}]_BS[{}]_LE[{}]_IID[{}]_LR[{}]_MMT[{}]_NT[{}]_NGN[{}]_GNR[{}]_PT[{}]_Tk[{}]'.format(args.dataset, 
                                                                                                     args.model, 
                                                                                                     args.epochs, 
                                                                                                     args.frac, 
                                                                                                     args.local_bs, 
        ...
        result_f = 'dividemix_{}_{}_{}_C[{}]_BS[{}]_LE[{}]_IID[{}]_LR[{}]_MMT[{}]_NT[{}]_NGN[{}]_GNR[{}]_Tk[{}]'.format(args.dataset, 
                                                                                                     args.model, 
                                                                                                     args.epochs, 
                                                                                                     args.frac, 
                                                                                                     args.local_bs, 
    ...
    for iter in range(args.epochs):
        ...
        for idx in idxs_users:
            local = LocalUpdateDivideMix(args=args, dataset=dataset_train, idxs=dict_users[idx])
            
            if iter <= args.warm_up:
                w1, w2 = local.warmup(net1=copy.deepcopy(net_glob1).to(args.device), 
                                      net2=copy.deepcopy(net_glob2).to(args.device))
            else:
                w1, w2, all_loss = local.train(g_epoch=iter,
                                               warmup=args.warm_up,
                                               net1=copy.deepcopy(net_glob1).to(args.device), 
                                               net2=copy.deepcopy(net_glob2).to(args.device), 
