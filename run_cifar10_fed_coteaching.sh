...
# python3 main_fed_coteaching.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type symmetric  --save_dir cifar10/coteaching/symmetric --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.3 --forget_rate 0.3

# python3 main_fed_coteaching.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type symmetric  --save_dir cifar10/coteaching/symmetric --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.6 --forget_rate 0.6

python3 main_fed_coteaching.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type pairflip  --save_dir cifar10/coteaching/pairflip --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.15 --forget_rate 0.15
python3 main_fed_coteaching.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type pairflip  --save_dir cifar10/coteaching/pairflip --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.25 --forget_rate 0.25
python3 main_fed_coteaching.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type pairflip  --save_dir cifar10/coteaching/pairflip --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.35 --forget_rate 0.35
python3 main_fed_coteaching.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type pairflip  --save_dir cifar10/coteaching/pairflip --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.45 --forget_rate 0.45