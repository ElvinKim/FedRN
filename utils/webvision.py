...
class webvision_dataloader:
    ...
    def run(self, mode):
        if mode == 'train':
            all_dataset = webvision_dataset(root_dir=self.root_dir, transform=self.transform_train, mode=mode,
            ...
            val_dataset = webvision_dataset(root_dir=self.root_dir, transform=self.transform_val, mode=mode,
                                            num_class=self.num_class)
