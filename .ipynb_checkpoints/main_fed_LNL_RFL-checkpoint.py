...
from models.Update import LocalUpdateRFL
...
if __name__ == '__main__':
    ...
    if args.model == 'cnn' and args.dataset == 'cifar':
        ...
        net_glob = MobileNetCifar(return_feature=True).to(args.device)
    else:
    ...
    for iter in range(args.epochs):
        ...
        for idx in idxs_users:
            local = LocalUpdateRFL(args=args, dataset=dataset_train, idxs=dict_users[idx], glob_centroid=glob_centroid)
