...
python3 main_fed_LNL.py --dataset cifar --model cnn --epochs 500 --local_ep 10 --save_dir cifar10 --noise_type clean --save_dir cifar10/No_LNL/IID_True/clean_lr_decay --lr 0.1  --partition label2  --iid
