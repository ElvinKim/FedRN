...
python3 main_fed_LG_finetuning.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type pairflip  --save_dir cifar10/LG_finetuning/pairflip --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.15 --forget_rate 0.15 --gpu 1

python3 main_fed_LG_finetuning.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type pairflip  --save_dir cifar10/LG_finetuning/pairflip --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.25 --forget_rate 0.25 --gpu 1

python3 main_fed_LG_finetuning.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type pairflip  --save_dir cifar10/LG_finetuning/pairflip --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.35 --forget_rate 0.35 --gpu 1

python3 main_fed_LG_finetuning.py --dataset cifar --model mobile --epochs 500  --local_ep 2 --save_dir cifar10 --noise_type pairflip  --save_dir cifar10/LG_finetuning/pairflip --lr 0.1 --partition label2 --noise_group_num 100 --group_noise_rate 0.45 --forget_rate 0.45 --gpu 1